						...
						<div class="map-filters">
							...
							<div class="filter-container">
								...
								foreach ( $map_categories as $map_category ) { ?>
									...
									<a href="#" data-category-bg="<?php echo $map_category['background_image']; ?>" data-category-num="<?php echo $cat_counter; ?>" data-category="<?php echo str_replace( '--', '-', str_replace( '&', '', str_replace( ' ', '-', strtolower( $map_category['name'] ) ) ) ); ?>" class="btn btn-primary btn-sm mt-1"><?php echo $map_category['name']; ?></a>
